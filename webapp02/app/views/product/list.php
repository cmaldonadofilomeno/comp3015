...
btn-primary'>Crear</a> </th>
<!-- Otros campos según sea necesario --> </tr>
</thead> <tbody>
...
<!-- Otros campos según sea necesario --> <td class='text-center'>
<a href='index.php?url=product/update/<?php echo htmlspecialchars($product['id'], ENT_QUOTES, 'UTF-8'); ?>' class='btn
btn-success'>Editar</a>
<a href='index.php?url=product/delete/<?php echo
htmlspecialchars($product['id'], ENT_QUOTES, 'UTF-8'); ?>' class='btn btn-danger'>Borrar</a>
</td> </tr>
